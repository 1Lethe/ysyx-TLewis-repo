...
image: image-dep
	...
	# FIXME: 修改正确的objcopy配置
	@$(OBJCOPY) -S --set-section-flags .bss=alloc,contents -O binary $(IMAGE).elf $(IMAGE).temp.bin
	@dd if=$(IMAGE).temp.bin of=$(IMAGE).bin bs=1M seek=240 status=none
