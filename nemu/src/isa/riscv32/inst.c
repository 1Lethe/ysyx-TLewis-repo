...
#define SRC2_DIV_0 Assert(src2 != 0, "src2 div by 0")
...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  /* Division */
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, SRC2_DIV_0;R(rd) = (sword_t)src1 % (sword_t)src2);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, SRC2_DIV_0;R(rd) = src1 % src2);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, SRC2_DIV_0;R(rd) = (sword_t)src1 / (sword_t)src2);
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, SRC2_DIV_0;R(rd) = src1 / src2);
