...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  /* Division */
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0) ? (sword_t)((int64_t)(sword_t)src1 % (int64_t)(sword_t)src2) : src2);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? (word_t)((uint64_t)src1 % (uint64_t)src2) : src2);
