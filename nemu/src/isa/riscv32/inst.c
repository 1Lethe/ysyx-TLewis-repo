...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  /* Division */
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, DIV_SRC2_EQU_0;R(rd) = (sword_t)src1 % (sword_t)src2);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, DIV_SRC2_EQU_0;R(rd) = src1 % src2);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, DIV_SRC2_EQU_0;R(rd) = (sword_t)src1 / (sword_t)src2);
