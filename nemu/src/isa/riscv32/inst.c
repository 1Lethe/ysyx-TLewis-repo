...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub    , R, R(rd) = BITS((src1 - src2), 31, 0));
  ...
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , N, word_t entry = isa_raise_intr(0xb, s->pc); s->dnpc = entry);
  INSTPAT("0000000 00001 00000 000 00000 11100 11", ebreak , N, NEMUTRAP(s->pc, R(10))); // R(10) is $a0
  
  /* RV32M */
  /* Multiplication */
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = (sword_t)(((int64_t)(sword_t)src1 * (int64_t)(sword_t)src2) & 0xFFFFFFFF));
  ...
  /* Division */
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0) ? (sword_t)((int64_t)(sword_t)src1 % (int64_t)(sword_t)src2) : src1);
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? (word_t)((uint64_t)src1 % (uint64_t)src2) : src1);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? (sword_t)(((int64_t)(sword_t)src1 / (int64_t)(sword_t)src2)) : ~0x0);
