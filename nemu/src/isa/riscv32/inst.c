...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, DIV_SRC2_EQU_0;R(rd) = src1 % src2);
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, DIV_SRC2_EQU_0;R(rd) = (sword_t)(((int64_t)src1 / (int64_t)src2) & 0xFFFFFFFF));
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, DIV_SRC2_EQU_0;R(rd) = ((uint64_t)src2 == 0) ? ((uint64_t)src1 / (uint64_t)src2) : ~0x0);
