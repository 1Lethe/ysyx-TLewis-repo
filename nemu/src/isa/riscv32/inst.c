...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  /* RV32M */
  /* Multiplication */
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = BITS(((int64_t)SEXT(src1, 64) * (int64_t)SEXT(src2, 64)), 31, 0));
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, R(rd) = BITS((((int64_t)SEXT(src1, 64) * (int64_t)SEXT(src2, 64)) >> 32), 63, 32));
  /* Division */
