...
parameter GPIO_CTRL_MMIO_BASE = 32'h1000_2000;
parameter GPIO_CTRL_MMIO_SIZE = 32'h0000_0010;
parameter PS2_CTRL_MMIO_BASE  = 32'h1001_1000;
parameter PS2_CTRL_MMIO_SIZE  = 32'h0000_0008;
parameter VGA_MMIO_BASE       = 32'h2100_0000;
parameter VGA_MMIO_SIZE       = 32'h0020_0000;
...
ysyx_24120013_axi_bridge #(
    ...
    .GPIO_CTRL_MMIO_BASE(GPIO_CTRL_MMIO_BASE),
    .GPIO_CTRL_MMIO_SIZE(GPIO_CTRL_MMIO_SIZE),
    .PS2_CTRL_MMIO_BASE (PS2_CTRL_MMIO_BASE),
    .PS2_CTRL_MMIO_SIZE (PS2_CTRL_MMIO_SIZE),
    .VGA_MMIO_BASE      (VGA_MMIO_BASE      ),
    .VGA_MMIO_SIZE      (VGA_MMIO_SIZE      ),
    .SRAM_MMIO_BASE     (SRAM_MMIO_BASE    ),
    .SRAM_MMIO_SIZE     (SRAM_MMIO_SIZE    ),
    .FLASH_MMIO_BASE    (FLASH_MMIO_BASE    ),
    .FLASH_MMIO_SIZE    (FLASH_MMIO_SIZE    ),
